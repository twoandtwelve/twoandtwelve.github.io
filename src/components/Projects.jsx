      ...
      <div className="flex flex-wrap justify-center gap-4">
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 pb-0 grow">
            ...
            <p>
              A Lethal Company mod that allows infinite use of the spray paint
              can item.
            </p>
          </div>
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            <a
              href="https://thunderstore.io/c/lethal-company/p/jacky/InfiniteSprayCans/"
              target="_blank"
            >
              <GoLinkExternal />
            </a>
            <a
              href="https://github.com/twoandtwelve/InfiniteSprayCans"
              target="_blank"
            >
              <AiOutlineGithub />
            </a>
        ...
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            ...
            <a
              href="https://github.com/twoandtwelve/twoandtwelve.github.io"
              target="_blank"
            >
              <AiOutlineGithub />
            </a>
        ...
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 pb-0 grow">
            ...
            <p>
              A Lethal Company mod that increases the spawnrate & difficulty of
              turrets.
            </p>
          </div>
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            <a
              href="https://thunderstore.io/c/lethal-company/p/jacky/HarderTurrets/"
              target="_blank"
            ...
            <a
              href="https://github.com/twoandtwelve/HarderTurrets"
              target="_blank"
              rel="noopener noreferrer"
            >
              <AiOutlineGithub />
        ...
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 pb-0 grow">
            ...
            <p>
              An escape room-like game developed collaboratively with two other
              classmates for a course project.
            </p>
          </div>
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            <a
              href="https://github.com/twoandtwelve/escape-room-game"
              target="_blank"
            >
              <AiOutlineGithub />
            </a>
        ...
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 pb-0 grow">
            ...
            <p>
              A Lethal Company mod that removes the alert that pops up when it
              gets late in-game.
            </p>
          </div>
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            <a
              href="https://thunderstore.io/c/lethal-company/p/jacky/NoLateNotification/"
              target="_blank"
            >
              <GoLinkExternal />
            </a>
            <a
              href="https://github.com/twoandtwelve/NoLateNotification"
              target="_blank"
            >
              <AiOutlineGithub />
            </a>
        ...
        <article className="flex flex-col max-w-screen-sm sm:max-w-project border border-slate-500 rounded-md bg-white drop-shadow-lg">
          ...
          <div className="p-4 pb-0 grow">
            ...
            <p>
              A Python script that generates a cheat sheet containing in-game
              item information for Terraria Calamity Mod.
            </p>
          </div>
          <div className="p-4 flex justify-end items-center gap-4 text-2xl">
            <a
              href="https://github.com/twoandtwelve/weapons-cheatsheet"
              target="_blank"
            >
              <AiOutlineGithub />
            </a>
